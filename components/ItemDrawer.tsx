      ...
      <Drawer.Root>
        ...
        <Drawer.Portal>
          ...
          <Drawer.Content className="bg-zinc-100 flex flex-col rounded-t-[10px] mt-24 fixed bottom-0 left-0 right-0 z-50">
            <div className="p-4 bg-white rounded-t-[10px] flex-1  max-h-[90vh] ">
              ...
              <div className="text-start text-md mt-2">
                ...
                voluptatum. Impedit, maiores? Lorem, ipsum dolor sit amet
                consectetur adipisicing elit. Aspernatur repudiandae,
                voluptatibus aliquam, explicabo amet facere quam quaerat illum
                veniam adipisci provident magni iusto nostrum dicta ullam
                consequuntur numquam corporis ad in veritatis eum! Sunt, a
                dolorum in voluptatum non accusamus. Lorem ipsum dolor sit amet
                consectetur, adipisicing elit. Vero cumque officia fugit
                deleniti unde ipsum quam voluptatibus ut minus asperiores, nulla
                adipisci est esse id! Totam, eveniet voluptatum. Impedit,
                maiores? Lorem, ipsum dolor sit amet consectetur adipisicing
                elit. Aspernatur repudiandae, voluptatibus aliquam, explicabo
                amet facere quam quaerat illum veniam adipisci provident magni
                iusto nostrum dicta ullam consequuntur numquam corporis ad in
                veritatis eum! Sunt, a dolorum in voluptatum non accusamus.
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Vero
                cumque officia fugit deleniti unde ipsum quam voluptatibus ut
                minus asperiores, nulla adipisci est esse id! Totam, eveniet
